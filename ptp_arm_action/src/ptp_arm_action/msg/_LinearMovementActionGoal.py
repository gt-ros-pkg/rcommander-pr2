...
class LinearMovementActionGoal(roslib.message.Message):
  _md5sum = "e6601c2fadd91c3a183fcdd096743971"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2d3I.pack(_x.goal.trans_vel, _x.goal.rot_vel, _x.goal.goal.header.seq, _x.goal.goal.header.stamp.secs, _x.goal.goal.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.trans_vel, _x.goal.rot_vel, _x.goal.goal.header.seq, _x.goal.goal.header.stamp.secs, _x.goal.goal.header.stamp.nsecs,) = _struct_2d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
